package br.com.site.selenium.core.driver;

import br.com.site.selenium.core.utils.report.screenshot.ScenarioRepository;
...
import static br.com.site.selenium.core.driver.DriverFactory.getDriverWait;
...
public class BasePage {
    ...
    /**
     * Wait aguardando elemento ser clicavel
     */
    protected void waitForElementPageToBeClickable(WebElement element){
        wait = new WebDriverWait(getDriver(), 15);
        wait.until(ExpectedConditions.elementToBeClickable(element));
    }
    /**
     * Wait aguardando elemento ser visivel
     */
